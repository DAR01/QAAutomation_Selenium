...
public class ElementUtil {
	...
	//don't forget the prevalence order of finding and interacting with elements:
		//1. driver findEelement or
		//2. Action class with locator reference to locate and interact with element or
		//3. through JavaScript executor directly in the DOM
